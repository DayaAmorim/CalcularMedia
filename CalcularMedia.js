...
let cxNota5 = document.querySelector('#nota5')
let cxNota6 = document.querySelector('#nota6')
let cxMedia = document.querySelector('#media')
let cxSituacao = document.querySelector('#situacao')

// CALCULAR MEDIA
function calcularMedia(n1, n2, n3, n4, n5, n6) {
...
function validarNumero(numero) {
    ...
    let num5 = cxNota5.value
    let num6 = cxNota6.value
...
// usar metodo parseFloat p converter string p float
    ...
    let nota5 = parseFloat(cxNota5.value)
    let nota6 = parseFloat(cxNota6.value)
    let media = calcularMedia(nota1, nota2, nota3, nota4, nota5, nota6)
